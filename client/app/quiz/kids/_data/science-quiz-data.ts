...
export const scienceQuizData: quizDataProps[] = [
  {
  ...
  },
  {
    ...
    answers: ["Water", "Nectar", "Pollen", "Leaves"],
    correct: "Nectar",
  },
  {
  ...
  {
    question: "What do we call the young one of a frog?",
    answers: ["Tadpole", "Cub", "Chick", "Larva"],
    correct: "Tadpole",
  },
  {
  ...
  },
  {
    ...
    answers: ["Fish", "Bird", "Mammal", "Reptile"],
    correct: "Mammal",
  },
  {
  ...
  {
    question: "Which planet in our solar system has the largest ring system?",
  ...
  {
    question:
      "What type of animal is a butterfly before it becomes a butterfly?",
    answers: ["Egg", "Larva", "Caterpillar", "Pupa"],
    correct: "Caterpillar",
  },
  {
    question:
  ...
  {
    question:
      "What type of habitat is characterized by vast stretches of sand with little vegetation and extreme temperatures?",
    answers: ["Forest", "Desert", "Tundra", "Grassland"],
    correct: "Desert",
  },
  {
    question:
      "What is the name of the desert located in northern Africa known for its vast sand dunes?",
    answers: [
      "Gobi Desert",
      "Sahara Desert",
      "Kalahari Desert",
